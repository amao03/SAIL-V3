...
struct Phone_Landing_View : View{
    ...
    var body: some View {
        NavigationView{
            Form{
                Picker("select type", selection: $currTest.type) {
...
//                })
                ...
                Section("Above Pattern", content: {
                    NavigationLink(destination: {
                        MadeHapticsSelector(selectedItems: $currTest.abovePattern)
                    }, label: {
                        Text("Select haptics")
                    })
                ...
                Section("At Pattern", content: {
                    ...
                    Spacer()
                    NavigationLink(destination: {
                        MadeHapticsSelector(selectedItems: $currTest.atPattern)
                    }, label: {
                        Text("Select haptics")
                    })
                ...
                Section("Under Pattern", content: {
                    NavigationLink(destination: {
                        MadeHapticsSelector(selectedItems: $currTest.underPattern)
                    }, label: {
                        Text("Select haptics")
                    })
                ...
                if (!hasConnectedRower && currTest.type == DataType.rower){
